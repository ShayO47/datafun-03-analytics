...
> Shalynne Orth's professional Python project: working with data files for analytics.
...
```shell
git clone https://github.com/ShayO47/datafun-03-analytics
...
- [Documentation](https://ShayO47.github.io/datafun-03-analytics/)
