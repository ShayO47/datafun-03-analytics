...
extract the average audience-rating column,
calculate descriptive statistics,
verify the results,
and write the statistics to a text file.
"""

CSV_INPUT: Final[Path] = RAW_DIR / "tmdb_movies.csv"
CSV_OUTPUT: Final[Path] = PROCESSED_DIR / "tmdb_vote_average_stats.txt"
CSV_COLUMN: Final[str] = "vote_average"

WHY_CSV_COLUMN: Final[str] = r"""
The vote_average column records the average audience rating for each movie.
Summarizing this column shows the typical rating level and the range of
ratings in the TMDb movie dataset.
"""

CSV_ANALYST_INSIGHT: Final[str] = r"""
The 10,000 movies had an average vote_average of 6.31 out of 10.
The standard deviation was 1.35, so ratings varied across the dataset.
The full range from 0.00 to 10.00 shows that the dataset includes both
very low- and very high-rated movies. Since this is a popular-movie dataset,
the results may not represent every movie in the full TMDb collection.
"""
